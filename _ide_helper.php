...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getCost($name)
        {
                        /** @var \Gloudemans\Shoppingcart\Cart $instance */
                        return $instance->getCost($name);
        }
                    /**
         ...
         * @static 
         */ 
        public static function merge($identifier, $keepTax = false, $dispatchAdd = true, $instance = 'default')
        {
                        /** @var \Gloudemans\Shoppingcart\Cart $instance */
                        return $instance->merge($identifier, $keepTax, $dispatchAdd, $instance);
        }
                    /**
         * Add an item to the cart.
         *
         ...
         * @static 
         */ 
        public static function addCartItem($item, $keepTax = false, $dispatchEvent = true)
        {
                        /** @var \Gloudemans\Shoppingcart\Cart $instance */
                        return $instance->addCartItem($item, $keepTax, $dispatchEvent);
        }
     ...
     */ 
        ...
        public static function reset()
        {
                        /** @var \SynergiTech\Alert\Alert $instance */
                        return $instance->reset();
        }
                    /**
         * 
         ...
         * @static 
         */ 
        public static function as($desiredOutput)
        {
                        /** @var \SynergiTech\Alert\Alert $instance */
                        return $instance->as($desiredOutput);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function output($desiredOutput)
        {
                        /** @var \SynergiTech\Alert\Alert $instance */
                        return $instance->output($desiredOutput);
        }
                    /**
        ...
        {
                        /** @var \SynergiTech\Alert\Alert $instance */
                        return $instance->message($text, $title, $type);
        }
...
namespace  { 
            ...
            class Alert extends \SynergiTech\Alert\Facade {}
